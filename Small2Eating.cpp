...
private:
    ...
    void updateSpriteRect() {
        ...
        int frameWidth = texture.getSize().x / 3;  // There are 3 columns (frames) in the first row
...
int main() {
    ...
    Eating eating("Small2/Eating/spritesheet.png", 0.8f, 2.2f, 2.2f);  // 1 second for the first frame, scale by 1.5
