...
{
public:
    // Constructor to load the sprite sheet for sleeping animation
        ...
        : frameDuration(frameDuration), currentFrame(0), isAnimating(false)
    {
        ...
        // Scale the sprite to make it larger
        sprite.setScale(scaleX, scaleY); // Set scale factors for X and Y
...
int main()
{
    ...
    Sleeping sleeping("Small/Sleeping.png", 0.8f, 2.2f, 2.2f);  // Adjust scale factors as needed
