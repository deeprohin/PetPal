...
void EatingShop::initializeBabyItems() {
  ...
  imagePaths = {"Images/Pumpkin.png", "Images/Milk2.png", "Images/Porridge.png",
...
void EatingShop::initializeAdultItems() {
  ...
  imagePaths = {"Images/Steak.png", "Images/FriedRice.png", "Images/Curry.png",
                "Images/Boba.png", "Images/ColdRolls.png"};
}

// Getter for item names
std::vector<std::string> EatingShop::getItemNames() { return itemNames; }

// Getter for image paths
std::vector<std::string> EatingShop::getImagePaths() { return imagePaths; }
