...
private:
    ...
    void updateSpriteRect()
    {
        ...
        int frameWidth = texture.getSize().x / 3;  // There are 3 columns in the sprite sheet
        int frameHeight = texture.getSize().y; // The height is the same for all frames
...
int main()
{
    ...
    Eating eating("Big2/eating/spritesheet.png", 1.4f, 2.9f, 2.9f);  // Adjust frame duration and scaling
