...
int main() {
    ...
    std::vector<std::string> initialItems = {"Baby Pumpkin", "Baby Banana", "Yakult", "Baby Medicine"};
    std::vector<int> initialPrices = {100, 50, 50, 500};
    ...
    for (size_t i = 0; i < initialItems.size(); ++i) {
        ...
        basket[basketSize].texture = nullptr; // Will be loaded in EatingBabyAvo
    ...
    // Create an instance of the EatingBabyAvo class
    EatingBabyAvo eatingWindow(font, basket, basketSize, basketCapacity, trolleyCount);
