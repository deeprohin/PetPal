    ...
    void updateSpriteRect() {
        ...
        switch (currentFrame) {
            case 0: // First frame (Row 1, Column 1)
                frameX = 0; // Corrected frame position
                frameY = 0;
                break;
...
int main() {
    ...
    // Load the sprite sheet for the "Medicine" activity with scaling factors
    Medicine medicine("Small2/medications/spritesheet.png", 0.8f, 2.2f, 2.2f);  // Adjust frame duration and scaling as needed
