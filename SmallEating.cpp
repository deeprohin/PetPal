...
int main()
{
    ...
    // Load the sprite sheet for the "eating" activity (3 frames) with scaling factors
    Eating eat("Small/eating.png", 0.8f, 2.2f, 2.2f);  // 0.75 seconds for the first frame, scaled by 2x
