...
int main() {
    ...
    std::vector<std::string> initialItems = {"Chicken", "Milk", "Apple", "Medicine", "Pizza", "Fish"};
    std::vector<int> initialPrices = {100, 50, 50, 500, 70, 70};
    ...
    for (size_t i = 0; i < initialItems.size(); ++i) {
        ...
        basket[basketSize].texture = nullptr; // Will be loaded in EatingAdultGhostWindow
    ...
    // Create an instance of the EatingAdultGhostWindow class
    EatingAdultGhostWindow eatingWindow(font, basket, basketSize, basketCapacity, trolleyCount);
