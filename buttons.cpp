...
#include "BaseItem.h" // Include the base item header
#include "FoodItem.h" // Include the derived food item header
...
int main() {
    ...
    ShoppingBasket shoppingBasket(10); // Create shopping basket with initial capacity
    ...
    // Display items in the shopping basket (optional for debugging)
