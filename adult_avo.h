...
class adult_avo : public Shower,public Eating,public Sleeping,public Medicine,public PetStats{
public:
...
void updateSpriteRect_sleeping() override{
    ...
    switch (currentFrame_sleeping) {
        ...
        case 1: frameX = 32; break;                // Second frame
        case 2: frameX = 64; break;            // Third frame
        case 3: frameX = 96; break;            // Fourth frame
