...
#include "Small2Sleeping.cpp"  // Include Sleeping if needed in your project
...
int main()
{
    ...
    Sleeping Sleeping("Small2/Sleeping/spritesheet.png", 0.8f, 2.2f, 2.2f);  // Adjust frame duration as needed, scaled by 2x
